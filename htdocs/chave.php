...
if ($msg == "usada"){
    echo '<script> alert("chave ja utilizada"); </script>';
}
?>
<head>
    <meta charset="utf-8">
                ...
                <div class="col s12 m13">
                    <div class="card-panel white center">
                        <span class="black-text">
                            <h3>Olá, insira sua chave de acesso!!</h3>
                            <form name="form" method="post" action="php/validar.php">
                                <br>
                                <div class="input-field">
                                    <label for="chave"> Chave </label>
                                    <input class="glyphicon-th" type="text" name="chave">
                                </div>
                                <!--btn Enviar-->
                                <button class="btn waves-effect grey darken-4" type="submit" name="Enviar">Verificar
